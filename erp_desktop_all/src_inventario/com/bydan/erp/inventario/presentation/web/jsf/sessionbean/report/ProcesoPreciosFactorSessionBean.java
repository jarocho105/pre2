...
public class ProcesoPreciosFactorSessionBean  extends ProcesoPreciosFactorSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor;
	protected Long lIdProcesoPreciosFactorActualForeignKey;	
	
	protected Long lIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras;
	protected String sUltimaBusquedaProcesoPreciosFactor;
	...
	public ProcesoPreciosFactorSessionBean () {
		this.inicializarProcesoPreciosFactorSessionBean();
	}
	
	public void inicializarProcesoPreciosFactorSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor=false;
		this.lIdProcesoPreciosFactorActualForeignKey=0L;
		this.lIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras=false;
		this.sUltimaBusquedaProcesoPreciosFactor ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor= isPermiteNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor(String sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor = sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoPreciosFactor;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor= isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactor;
	}
					
	public Long getlIdProcesoPreciosFactorActualForeignKey() {
		return lIdProcesoPreciosFactorActualForeignKey;
	}

	public void setlIdProcesoPreciosFactorActualForeignKey(
			Long lIdProcesoPreciosFactorActualForeignKey) {
		this.lIdProcesoPreciosFactorActualForeignKey = lIdProcesoPreciosFactorActualForeignKey;
	}
				    
	public Long getlIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras() {
		return lIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras;
	}

	public void setlIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras(
			Long lIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras) {
		this.lIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras = lIdProcesoPreciosFactorActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyProcesoPreciosFactorParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaProcesoPreciosFactor() {
		return sUltimaBusquedaProcesoPreciosFactor;
	}

	public void setsUltimaBusquedaProcesoPreciosFactor(String sUltimaBusquedaProcesoPreciosFactor) {
		this.sUltimaBusquedaProcesoPreciosFactor = sUltimaBusquedaProcesoPreciosFactor;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosFactor:Valor nulo no permitido en columna id");
					}
				}
