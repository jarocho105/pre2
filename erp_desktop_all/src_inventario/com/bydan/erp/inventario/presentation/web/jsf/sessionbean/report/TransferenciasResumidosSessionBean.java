...
public class TransferenciasResumidosSessionBean  extends TransferenciasResumidosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos;
	protected Long lIdTransferenciasResumidosActualForeignKey;	
	
	protected Long lIdTransferenciasResumidosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras;
	protected String sUltimaBusquedaTransferenciasResumidos;
	...
	public TransferenciasResumidosSessionBean () {
		this.inicializarTransferenciasResumidosSessionBean();
	}
	
	public void inicializarTransferenciasResumidosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos=false;
		this.lIdTransferenciasResumidosActualForeignKey=0L;
		this.lIdTransferenciasResumidosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras=false;
		this.sUltimaBusquedaTransferenciasResumidos ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos= isPermiteNavegacionHaciaForeignKeyDesdeTransferenciasResumidos;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos(String sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos = sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferenciasResumidos;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos() {
		return isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos= isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidos;
	}
					
	public Long getlIdTransferenciasResumidosActualForeignKey() {
		return lIdTransferenciasResumidosActualForeignKey;
	}

	public void setlIdTransferenciasResumidosActualForeignKey(
			Long lIdTransferenciasResumidosActualForeignKey) {
		this.lIdTransferenciasResumidosActualForeignKey = lIdTransferenciasResumidosActualForeignKey;
	}
				    
	public Long getlIdTransferenciasResumidosActualForeignKeyParaPosibleAtras() {
		return lIdTransferenciasResumidosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdTransferenciasResumidosActualForeignKeyParaPosibleAtras(
			Long lIdTransferenciasResumidosActualForeignKeyParaPosibleAtras) {
		this.lIdTransferenciasResumidosActualForeignKeyParaPosibleAtras = lIdTransferenciasResumidosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyTransferenciasResumidosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaTransferenciasResumidos() {
		return sUltimaBusquedaTransferenciasResumidos;
	}

	public void setsUltimaBusquedaTransferenciasResumidos(String sUltimaBusquedaTransferenciasResumidos) {
		this.sUltimaBusquedaTransferenciasResumidos = sUltimaBusquedaTransferenciasResumidos;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("TransferenciasResumidos:Valor nulo no permitido en columna id");
					}
				}
