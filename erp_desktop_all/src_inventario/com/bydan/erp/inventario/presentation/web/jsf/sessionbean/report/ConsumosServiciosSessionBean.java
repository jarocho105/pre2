...
public class ConsumosServiciosSessionBean  extends ConsumosServiciosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios;
	protected Long lIdConsumosServiciosActualForeignKey;	
	
	protected Long lIdConsumosServiciosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras;
	protected String sUltimaBusquedaConsumosServicios;
	...
	public ConsumosServiciosSessionBean () {
		this.inicializarConsumosServiciosSessionBean();
	}
	
	public void inicializarConsumosServiciosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios=false;
		this.lIdConsumosServiciosActualForeignKey=0L;
		this.lIdConsumosServiciosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras=false;
		this.sUltimaBusquedaConsumosServicios ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios= isPermiteNavegacionHaciaForeignKeyDesdeConsumosServicios;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios(String sNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios = sNombrePaginaNavegacionHaciaForeignKeyDesdeConsumosServicios;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios() {
		return isBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios= isBusquedaDesdeForeignKeySesionForeignKeyConsumosServicios;
	}
					
	public Long getlIdConsumosServiciosActualForeignKey() {
		return lIdConsumosServiciosActualForeignKey;
	}

	public void setlIdConsumosServiciosActualForeignKey(
			Long lIdConsumosServiciosActualForeignKey) {
		this.lIdConsumosServiciosActualForeignKey = lIdConsumosServiciosActualForeignKey;
	}
				    
	public Long getlIdConsumosServiciosActualForeignKeyParaPosibleAtras() {
		return lIdConsumosServiciosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdConsumosServiciosActualForeignKeyParaPosibleAtras(
			Long lIdConsumosServiciosActualForeignKeyParaPosibleAtras) {
		this.lIdConsumosServiciosActualForeignKeyParaPosibleAtras = lIdConsumosServiciosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyConsumosServiciosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaConsumosServicios() {
		return sUltimaBusquedaConsumosServicios;
	}

	public void setsUltimaBusquedaConsumosServicios(String sUltimaBusquedaConsumosServicios) {
		this.sUltimaBusquedaConsumosServicios = sUltimaBusquedaConsumosServicios;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id");
					}
				}
