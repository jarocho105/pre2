...
public class DemandaProductosSessionBean  extends DemandaProductosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos;
	protected Long lIdDemandaProductosActualForeignKey;	
	
	protected Long lIdDemandaProductosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras;
	protected String sUltimaBusquedaDemandaProductos;
	...
	public DemandaProductosSessionBean () {
		this.inicializarDemandaProductosSessionBean();
	}
	
	public void inicializarDemandaProductosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos=false;
		this.lIdDemandaProductosActualForeignKey=0L;
		this.lIdDemandaProductosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras=false;
		this.sUltimaBusquedaDemandaProductos ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos= isPermiteNavegacionHaciaForeignKeyDesdeDemandaProductos;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos(String sNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos = sNombrePaginaNavegacionHaciaForeignKeyDesdeDemandaProductos;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos= isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductos;
	}
					
	public Long getlIdDemandaProductosActualForeignKey() {
		return lIdDemandaProductosActualForeignKey;
	}

	public void setlIdDemandaProductosActualForeignKey(
			Long lIdDemandaProductosActualForeignKey) {
		this.lIdDemandaProductosActualForeignKey = lIdDemandaProductosActualForeignKey;
	}
				    
	public Long getlIdDemandaProductosActualForeignKeyParaPosibleAtras() {
		return lIdDemandaProductosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdDemandaProductosActualForeignKeyParaPosibleAtras(
			Long lIdDemandaProductosActualForeignKeyParaPosibleAtras) {
		this.lIdDemandaProductosActualForeignKeyParaPosibleAtras = lIdDemandaProductosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyDemandaProductosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaDemandaProductos() {
		return sUltimaBusquedaDemandaProductos;
	}

	public void setsUltimaBusquedaDemandaProductos(String sUltimaBusquedaDemandaProductos) {
		this.sUltimaBusquedaDemandaProductos = sUltimaBusquedaDemandaProductos;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id");
					}
				}
