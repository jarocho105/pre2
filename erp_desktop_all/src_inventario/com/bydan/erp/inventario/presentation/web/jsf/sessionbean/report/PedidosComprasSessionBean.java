...
public class PedidosComprasSessionBean  extends PedidosComprasSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdePedidosCompras;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras;
	protected Long lIdPedidosComprasActualForeignKey;	
	
	protected Long lIdPedidosComprasActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras;
	protected String sUltimaBusquedaPedidosCompras;
	...
	public PedidosComprasSessionBean () {
		this.inicializarPedidosComprasSessionBean();
	}
	
	public void inicializarPedidosComprasSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdePedidosCompras=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras=false;
		this.lIdPedidosComprasActualForeignKey=0L;
		this.lIdPedidosComprasActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras=false;
		this.sUltimaBusquedaPedidosCompras ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdePedidosCompras() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdePedidosCompras;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdePedidosCompras(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdePedidosCompras) {
		this.isPermiteNavegacionHaciaForeignKeyDesdePedidosCompras= isPermiteNavegacionHaciaForeignKeyDesdePedidosCompras;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras(String sNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras = sNombrePaginaNavegacionHaciaForeignKeyDesdePedidosCompras;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras= isBusquedaDesdeForeignKeySesionForeignKeyPedidosCompras;
	}
					
	public Long getlIdPedidosComprasActualForeignKey() {
		return lIdPedidosComprasActualForeignKey;
	}

	public void setlIdPedidosComprasActualForeignKey(
			Long lIdPedidosComprasActualForeignKey) {
		this.lIdPedidosComprasActualForeignKey = lIdPedidosComprasActualForeignKey;
	}
				    
	public Long getlIdPedidosComprasActualForeignKeyParaPosibleAtras() {
		return lIdPedidosComprasActualForeignKeyParaPosibleAtras;
	}

	public void setlIdPedidosComprasActualForeignKeyParaPosibleAtras(
			Long lIdPedidosComprasActualForeignKeyParaPosibleAtras) {
		this.lIdPedidosComprasActualForeignKeyParaPosibleAtras = lIdPedidosComprasActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyPedidosComprasParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaPedidosCompras() {
		return sUltimaBusquedaPedidosCompras;
	}

	public void setsUltimaBusquedaPedidosCompras(String sUltimaBusquedaPedidosCompras) {
		this.sUltimaBusquedaPedidosCompras = sUltimaBusquedaPedidosCompras;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidosCompras:Valor nulo no permitido en columna id");
					}
				}
