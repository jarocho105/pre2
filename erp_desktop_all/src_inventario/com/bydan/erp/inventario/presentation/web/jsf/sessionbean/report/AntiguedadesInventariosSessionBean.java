...
public class AntiguedadesInventariosSessionBean  extends AntiguedadesInventariosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios;
	protected Long lIdAntiguedadesInventariosActualForeignKey;	
	
	protected Long lIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras;
	protected String sUltimaBusquedaAntiguedadesInventarios;
	...
	public AntiguedadesInventariosSessionBean () {
		this.inicializarAntiguedadesInventariosSessionBean();
	}
	
	public void inicializarAntiguedadesInventariosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios=false;
		this.lIdAntiguedadesInventariosActualForeignKey=0L;
		this.lIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras=false;
		this.sUltimaBusquedaAntiguedadesInventarios ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios= isPermiteNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios(String sNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios = sNombrePaginaNavegacionHaciaForeignKeyDesdeAntiguedadesInventarios;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios() {
		return isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios= isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventarios;
	}
					
	public Long getlIdAntiguedadesInventariosActualForeignKey() {
		return lIdAntiguedadesInventariosActualForeignKey;
	}

	public void setlIdAntiguedadesInventariosActualForeignKey(
			Long lIdAntiguedadesInventariosActualForeignKey) {
		this.lIdAntiguedadesInventariosActualForeignKey = lIdAntiguedadesInventariosActualForeignKey;
	}
				    
	public Long getlIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras() {
		return lIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras(
			Long lIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras) {
		this.lIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras = lIdAntiguedadesInventariosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyAntiguedadesInventariosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaAntiguedadesInventarios() {
		return sUltimaBusquedaAntiguedadesInventarios;
	}

	public void setsUltimaBusquedaAntiguedadesInventarios(String sUltimaBusquedaAntiguedadesInventarios) {
		this.sUltimaBusquedaAntiguedadesInventarios = sUltimaBusquedaAntiguedadesInventarios;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("AntiguedadesInventarios:Valor nulo no permitido en columna id");
					}
				}
