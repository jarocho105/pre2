...
public class GrupoBodegaSessionBean  extends GrupoBodegaSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega;
	protected Long lIdGrupoBodegaActualForeignKey;	
	
	protected Long lIdGrupoBodegaActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras;
	protected String sUltimaBusquedaGrupoBodega;
	...
	public GrupoBodegaSessionBean () {
		this.inicializarGrupoBodegaSessionBean();
	}
	
	public void inicializarGrupoBodegaSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega=false;
		this.lIdGrupoBodegaActualForeignKey=0L;
		this.lIdGrupoBodegaActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras=false;
		this.sUltimaBusquedaGrupoBodega ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega= isPermiteNavegacionHaciaForeignKeyDesdeGrupoBodega;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega(String sNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega = sNombrePaginaNavegacionHaciaForeignKeyDesdeGrupoBodega;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega() {
		return isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega= isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodega;
	}
					
	public Long getlIdGrupoBodegaActualForeignKey() {
		return lIdGrupoBodegaActualForeignKey;
	}

	public void setlIdGrupoBodegaActualForeignKey(
			Long lIdGrupoBodegaActualForeignKey) {
		this.lIdGrupoBodegaActualForeignKey = lIdGrupoBodegaActualForeignKey;
	}
				    
	public Long getlIdGrupoBodegaActualForeignKeyParaPosibleAtras() {
		return lIdGrupoBodegaActualForeignKeyParaPosibleAtras;
	}

	public void setlIdGrupoBodegaActualForeignKeyParaPosibleAtras(
			Long lIdGrupoBodegaActualForeignKeyParaPosibleAtras) {
		this.lIdGrupoBodegaActualForeignKeyParaPosibleAtras = lIdGrupoBodegaActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyGrupoBodegaParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaGrupoBodega() {
		return sUltimaBusquedaGrupoBodega;
	}

	public void setsUltimaBusquedaGrupoBodega(String sUltimaBusquedaGrupoBodega) {
		this.sUltimaBusquedaGrupoBodega = sUltimaBusquedaGrupoBodega;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("GrupoBodega:Valor nulo no permitido en columna id");
					}
				}
