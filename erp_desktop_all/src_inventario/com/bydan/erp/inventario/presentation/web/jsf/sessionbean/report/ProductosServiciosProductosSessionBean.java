...
public class ProductosServiciosProductosSessionBean  extends ProductosServiciosProductosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos;
	protected Long lIdProductosServiciosProductosActualForeignKey;	
	
	protected Long lIdProductosServiciosProductosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras;
	protected String sUltimaBusquedaProductosServiciosProductos;
	...
	public ProductosServiciosProductosSessionBean () {
		this.inicializarProductosServiciosProductosSessionBean();
	}
	
	public void inicializarProductosServiciosProductosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos=false;
		this.lIdProductosServiciosProductosActualForeignKey=0L;
		this.lIdProductosServiciosProductosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras=false;
		this.sUltimaBusquedaProductosServiciosProductos ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos= isPermiteNavegacionHaciaForeignKeyDesdeProductosServiciosProductos;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos(String sNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos = sNombrePaginaNavegacionHaciaForeignKeyDesdeProductosServiciosProductos;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos= isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductos;
	}
					
	public Long getlIdProductosServiciosProductosActualForeignKey() {
		return lIdProductosServiciosProductosActualForeignKey;
	}

	public void setlIdProductosServiciosProductosActualForeignKey(
			Long lIdProductosServiciosProductosActualForeignKey) {
		this.lIdProductosServiciosProductosActualForeignKey = lIdProductosServiciosProductosActualForeignKey;
	}
				    
	public Long getlIdProductosServiciosProductosActualForeignKeyParaPosibleAtras() {
		return lIdProductosServiciosProductosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdProductosServiciosProductosActualForeignKeyParaPosibleAtras(
			Long lIdProductosServiciosProductosActualForeignKeyParaPosibleAtras) {
		this.lIdProductosServiciosProductosActualForeignKeyParaPosibleAtras = lIdProductosServiciosProductosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyProductosServiciosProductosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaProductosServiciosProductos() {
		return sUltimaBusquedaProductosServiciosProductos;
	}

	public void setsUltimaBusquedaProductosServiciosProductos(String sUltimaBusquedaProductosServiciosProductos) {
		this.sUltimaBusquedaProductosServiciosProductos = sUltimaBusquedaProductosServiciosProductos;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosProductos:Valor nulo no permitido en columna id");
					}
				}
