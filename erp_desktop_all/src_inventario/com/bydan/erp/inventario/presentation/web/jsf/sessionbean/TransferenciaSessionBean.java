...
public class TransferenciaSessionBean  extends TransferenciaSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeTransferencia;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferencia;
	protected Long lIdTransferenciaActualForeignKey;	
	
	protected Long lIdTransferenciaActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras;
	protected String sUltimaBusquedaTransferencia;
	...
	public TransferenciaSessionBean () {
		this.inicializarTransferenciaSessionBean();
	}
	
	public void inicializarTransferenciaSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeTransferencia=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferencia=false;
		this.lIdTransferenciaActualForeignKey=0L;
		this.lIdTransferenciaActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras=false;
		this.sUltimaBusquedaTransferencia ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeTransferencia() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeTransferencia;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeTransferencia(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeTransferencia) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeTransferencia= isPermiteNavegacionHaciaForeignKeyDesdeTransferencia;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia(String sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia = sNombrePaginaNavegacionHaciaForeignKeyDesdeTransferencia;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyTransferencia() {
		return isBusquedaDesdeForeignKeySesionForeignKeyTransferencia;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyTransferencia(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferencia) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferencia= isBusquedaDesdeForeignKeySesionForeignKeyTransferencia;
	}
					
	public Long getlIdTransferenciaActualForeignKey() {
		return lIdTransferenciaActualForeignKey;
	}

	public void setlIdTransferenciaActualForeignKey(
			Long lIdTransferenciaActualForeignKey) {
		this.lIdTransferenciaActualForeignKey = lIdTransferenciaActualForeignKey;
	}
				    
	public Long getlIdTransferenciaActualForeignKeyParaPosibleAtras() {
		return lIdTransferenciaActualForeignKeyParaPosibleAtras;
	}

	public void setlIdTransferenciaActualForeignKeyParaPosibleAtras(
			Long lIdTransferenciaActualForeignKeyParaPosibleAtras) {
		this.lIdTransferenciaActualForeignKeyParaPosibleAtras = lIdTransferenciaActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyTransferenciaParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaTransferencia() {
		return sUltimaBusquedaTransferencia;
	}

	public void setsUltimaBusquedaTransferencia(String sUltimaBusquedaTransferencia) {
		this.sUltimaBusquedaTransferencia = sUltimaBusquedaTransferencia;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id");
					}
				}
