...
public class ProcesoCrearEtiquetasProductosSessionBean  extends ProcesoCrearEtiquetasProductosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos;
	protected Long lIdProcesoCrearEtiquetasProductosActualForeignKey;	
	
	protected Long lIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras;
	protected String sUltimaBusquedaProcesoCrearEtiquetasProductos;
	...
	public ProcesoCrearEtiquetasProductosSessionBean () {
		this.inicializarProcesoCrearEtiquetasProductosSessionBean();
	}
	
	public void inicializarProcesoCrearEtiquetasProductosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos=false;
		this.lIdProcesoCrearEtiquetasProductosActualForeignKey=0L;
		this.lIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras=false;
		this.sUltimaBusquedaProcesoCrearEtiquetasProductos ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos= isPermiteNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos(String sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos = sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoCrearEtiquetasProductos;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos= isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductos;
	}
					
	public Long getlIdProcesoCrearEtiquetasProductosActualForeignKey() {
		return lIdProcesoCrearEtiquetasProductosActualForeignKey;
	}

	public void setlIdProcesoCrearEtiquetasProductosActualForeignKey(
			Long lIdProcesoCrearEtiquetasProductosActualForeignKey) {
		this.lIdProcesoCrearEtiquetasProductosActualForeignKey = lIdProcesoCrearEtiquetasProductosActualForeignKey;
	}
				    
	public Long getlIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras() {
		return lIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras(
			Long lIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras) {
		this.lIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras = lIdProcesoCrearEtiquetasProductosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyProcesoCrearEtiquetasProductosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaProcesoCrearEtiquetasProductos() {
		return sUltimaBusquedaProcesoCrearEtiquetasProductos;
	}

	public void setsUltimaBusquedaProcesoCrearEtiquetasProductos(String sUltimaBusquedaProcesoCrearEtiquetasProductos) {
		this.sUltimaBusquedaProcesoCrearEtiquetasProductos = sUltimaBusquedaProcesoCrearEtiquetasProductos;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoCrearEtiquetasProductos:Valor nulo no permitido en columna id");
					}
				}
