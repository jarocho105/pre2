...
public class DetalleCodigoBarraProductoSessionBean  extends DetalleCodigoBarraProductoSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto;
	protected Long lIdDetalleCodigoBarraProductoActualForeignKey;	
	
	protected Long lIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras;
	protected String sUltimaBusquedaDetalleCodigoBarraProducto;
	...
	public DetalleCodigoBarraProductoSessionBean () {
		this.inicializarDetalleCodigoBarraProductoSessionBean();
	}
	
	public void inicializarDetalleCodigoBarraProductoSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto=false;
		this.lIdDetalleCodigoBarraProductoActualForeignKey=0L;
		this.lIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras=false;
		this.sUltimaBusquedaDetalleCodigoBarraProducto ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto= isPermiteNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto(String sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto = sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleCodigoBarraProducto;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto= isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProducto;
	}
					
	public Long getlIdDetalleCodigoBarraProductoActualForeignKey() {
		return lIdDetalleCodigoBarraProductoActualForeignKey;
	}

	public void setlIdDetalleCodigoBarraProductoActualForeignKey(
			Long lIdDetalleCodigoBarraProductoActualForeignKey) {
		this.lIdDetalleCodigoBarraProductoActualForeignKey = lIdDetalleCodigoBarraProductoActualForeignKey;
	}
				    
	public Long getlIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras() {
		return lIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras;
	}

	public void setlIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras(
			Long lIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras) {
		this.lIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras = lIdDetalleCodigoBarraProductoActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyDetalleCodigoBarraProductoParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaDetalleCodigoBarraProducto() {
		return sUltimaBusquedaDetalleCodigoBarraProducto;
	}

	public void setsUltimaBusquedaDetalleCodigoBarraProducto(String sUltimaBusquedaDetalleCodigoBarraProducto) {
		this.sUltimaBusquedaDetalleCodigoBarraProducto = sUltimaBusquedaDetalleCodigoBarraProducto;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCodigoBarraProducto:Valor nulo no permitido en columna id");
					}
				}
