...
public class DisponiblesCostosSessionBean  extends DisponiblesCostosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos;
	protected Long lIdDisponiblesCostosActualForeignKey;	
	
	protected Long lIdDisponiblesCostosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras;
	protected String sUltimaBusquedaDisponiblesCostos;
	...
	public DisponiblesCostosSessionBean () {
		this.inicializarDisponiblesCostosSessionBean();
	}
	
	public void inicializarDisponiblesCostosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos=false;
		this.lIdDisponiblesCostosActualForeignKey=0L;
		this.lIdDisponiblesCostosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras=false;
		this.sUltimaBusquedaDisponiblesCostos ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos= isPermiteNavegacionHaciaForeignKeyDesdeDisponiblesCostos;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos(String sNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos = sNombrePaginaNavegacionHaciaForeignKeyDesdeDisponiblesCostos;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos= isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostos;
	}
					
	public Long getlIdDisponiblesCostosActualForeignKey() {
		return lIdDisponiblesCostosActualForeignKey;
	}

	public void setlIdDisponiblesCostosActualForeignKey(
			Long lIdDisponiblesCostosActualForeignKey) {
		this.lIdDisponiblesCostosActualForeignKey = lIdDisponiblesCostosActualForeignKey;
	}
				    
	public Long getlIdDisponiblesCostosActualForeignKeyParaPosibleAtras() {
		return lIdDisponiblesCostosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdDisponiblesCostosActualForeignKeyParaPosibleAtras(
			Long lIdDisponiblesCostosActualForeignKeyParaPosibleAtras) {
		this.lIdDisponiblesCostosActualForeignKeyParaPosibleAtras = lIdDisponiblesCostosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyDisponiblesCostosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaDisponiblesCostos() {
		return sUltimaBusquedaDisponiblesCostos;
	}

	public void setsUltimaBusquedaDisponiblesCostos(String sUltimaBusquedaDisponiblesCostos) {
		this.sUltimaBusquedaDisponiblesCostos = sUltimaBusquedaDisponiblesCostos;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DisponiblesCostos:Valor nulo no permitido en columna id");
					}
				}
