...
public class OrdenCompraSessionBean  extends OrdenCompraSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra;
	protected Long lIdOrdenCompraActualForeignKey;	
	
	protected Long lIdOrdenCompraActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras;
	protected String sUltimaBusquedaOrdenCompra;
	...
	Boolean isBusquedaDesdeForeignKeySesionEstadoOrdenCompra;
	Long lidEstadoOrdenCompraActual;
	...
	public OrdenCompraSessionBean () {
		this.inicializarOrdenCompraSessionBean();
	}
	
	public void inicializarOrdenCompraSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra=false;
		this.lIdOrdenCompraActualForeignKey=0L;
		this.lIdOrdenCompraActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras=false;
		this.sUltimaBusquedaOrdenCompra ="";
		...
		isBusquedaDesdeForeignKeySesionEstadoOrdenCompra=false;
		lidEstadoOrdenCompraActual=0L;
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra= isPermiteNavegacionHaciaForeignKeyDesdeOrdenCompra;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra(String sNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra = sNombrePaginaNavegacionHaciaForeignKeyDesdeOrdenCompra;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra() {
		return isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra= isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompra;
	}
					
	public Long getlIdOrdenCompraActualForeignKey() {
		return lIdOrdenCompraActualForeignKey;
	}

	public void setlIdOrdenCompraActualForeignKey(
			Long lIdOrdenCompraActualForeignKey) {
		this.lIdOrdenCompraActualForeignKey = lIdOrdenCompraActualForeignKey;
	}
				    
	public Long getlIdOrdenCompraActualForeignKeyParaPosibleAtras() {
		return lIdOrdenCompraActualForeignKeyParaPosibleAtras;
	}

	public void setlIdOrdenCompraActualForeignKeyParaPosibleAtras(
			Long lIdOrdenCompraActualForeignKeyParaPosibleAtras) {
		this.lIdOrdenCompraActualForeignKeyParaPosibleAtras = lIdOrdenCompraActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyOrdenCompraParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaOrdenCompra() {
		return sUltimaBusquedaOrdenCompra;
	}

	public void setsUltimaBusquedaOrdenCompra(String sUltimaBusquedaOrdenCompra) {
		this.sUltimaBusquedaOrdenCompra = sUltimaBusquedaOrdenCompra;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("OrdenCompra:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeForeignKeySesionEstadoOrdenCompra() {
		return isBusquedaDesdeForeignKeySesionEstadoOrdenCompra;
	}

	public void setisBusquedaDesdeForeignKeySesionEstadoOrdenCompra(
		Boolean isBusquedaDesdeForeignKeySesionEstadoOrdenCompra) {
		this.isBusquedaDesdeForeignKeySesionEstadoOrdenCompra = isBusquedaDesdeForeignKeySesionEstadoOrdenCompra;
	}

	public Long getlidEstadoOrdenCompraActual() {
		return lidEstadoOrdenCompraActual;
	}

	public void setlidEstadoOrdenCompraActual(Long lidEstadoOrdenCompraActual) {
		this.lidEstadoOrdenCompraActual = lidEstadoOrdenCompraActual;
	}
