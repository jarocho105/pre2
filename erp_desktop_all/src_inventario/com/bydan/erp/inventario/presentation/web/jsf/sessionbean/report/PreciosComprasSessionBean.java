...
public class PreciosComprasSessionBean  extends PreciosComprasSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdePreciosCompras;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras;
	protected Long lIdPreciosComprasActualForeignKey;	
	
	protected Long lIdPreciosComprasActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras;
	protected String sUltimaBusquedaPreciosCompras;
	...
	public PreciosComprasSessionBean () {
		this.inicializarPreciosComprasSessionBean();
	}
	
	public void inicializarPreciosComprasSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdePreciosCompras=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras=false;
		this.lIdPreciosComprasActualForeignKey=0L;
		this.lIdPreciosComprasActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras=false;
		this.sUltimaBusquedaPreciosCompras ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdePreciosCompras() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdePreciosCompras;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdePreciosCompras(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdePreciosCompras) {
		this.isPermiteNavegacionHaciaForeignKeyDesdePreciosCompras= isPermiteNavegacionHaciaForeignKeyDesdePreciosCompras;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras(String sNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras = sNombrePaginaNavegacionHaciaForeignKeyDesdePreciosCompras;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras= isBusquedaDesdeForeignKeySesionForeignKeyPreciosCompras;
	}
					
	public Long getlIdPreciosComprasActualForeignKey() {
		return lIdPreciosComprasActualForeignKey;
	}

	public void setlIdPreciosComprasActualForeignKey(
			Long lIdPreciosComprasActualForeignKey) {
		this.lIdPreciosComprasActualForeignKey = lIdPreciosComprasActualForeignKey;
	}
				    
	public Long getlIdPreciosComprasActualForeignKeyParaPosibleAtras() {
		return lIdPreciosComprasActualForeignKeyParaPosibleAtras;
	}

	public void setlIdPreciosComprasActualForeignKeyParaPosibleAtras(
			Long lIdPreciosComprasActualForeignKeyParaPosibleAtras) {
		this.lIdPreciosComprasActualForeignKeyParaPosibleAtras = lIdPreciosComprasActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyPreciosComprasParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaPreciosCompras() {
		return sUltimaBusquedaPreciosCompras;
	}

	public void setsUltimaBusquedaPreciosCompras(String sUltimaBusquedaPreciosCompras) {
		this.sUltimaBusquedaPreciosCompras = sUltimaBusquedaPreciosCompras;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id");
					}
				}
