...
public class ConteosFisicosSessionBean  extends ConteosFisicosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos;
	protected Long lIdConteosFisicosActualForeignKey;	
	
	protected Long lIdConteosFisicosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras;
	protected String sUltimaBusquedaConteosFisicos;
	...
	public ConteosFisicosSessionBean () {
		this.inicializarConteosFisicosSessionBean();
	}
	
	public void inicializarConteosFisicosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos=false;
		this.lIdConteosFisicosActualForeignKey=0L;
		this.lIdConteosFisicosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras=false;
		this.sUltimaBusquedaConteosFisicos ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos= isPermiteNavegacionHaciaForeignKeyDesdeConteosFisicos;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos(String sNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos = sNombrePaginaNavegacionHaciaForeignKeyDesdeConteosFisicos;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos() {
		return isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos= isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicos;
	}
					
	public Long getlIdConteosFisicosActualForeignKey() {
		return lIdConteosFisicosActualForeignKey;
	}

	public void setlIdConteosFisicosActualForeignKey(
			Long lIdConteosFisicosActualForeignKey) {
		this.lIdConteosFisicosActualForeignKey = lIdConteosFisicosActualForeignKey;
	}
				    
	public Long getlIdConteosFisicosActualForeignKeyParaPosibleAtras() {
		return lIdConteosFisicosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdConteosFisicosActualForeignKeyParaPosibleAtras(
			Long lIdConteosFisicosActualForeignKeyParaPosibleAtras) {
		this.lIdConteosFisicosActualForeignKeyParaPosibleAtras = lIdConteosFisicosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyConteosFisicosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaConteosFisicos() {
		return sUltimaBusquedaConteosFisicos;
	}

	public void setsUltimaBusquedaConteosFisicos(String sUltimaBusquedaConteosFisicos) {
		this.sUltimaBusquedaConteosFisicos = sUltimaBusquedaConteosFisicos;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConteosFisicos:Valor nulo no permitido en columna id");
					}
				}
