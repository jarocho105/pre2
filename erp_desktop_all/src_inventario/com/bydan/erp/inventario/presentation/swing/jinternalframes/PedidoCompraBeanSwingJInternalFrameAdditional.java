...
public class PedidoCompraBeanSwingJInternalFrameAdditional extends JInternalFrameBase//PedidoCompraBeanSwingJInternalFrame
{
private static final long serialVersionUID = 1L;
	//CONTROL_INICIO
	PedidoCompraLogic pedidocompraLogic;
	PedidoCompraLogicAdditional pedidocompraLogicAdditional;
	Mensaje mensaje;
	public static int openFrameCount = 0;
    public static final int xOffset = 10, yOffset = 35;
	
	
	public  PedidoCompraBeanSwingJInternalFrameAdditional(PaginaTipo paginaTipo) throws Exception
	{
		super(paginaTipo);
		try 
		{			
			
			pedidocompraLogic=new PedidoCompraLogic();
			pedidocompraLogicAdditional=new PedidoCompraLogicAdditional();
	...
	public static void	RecargarFormPedidoCompra(PedidoCompraBeanSwingJInternalFrame pedidocompraBeanSwingJInternalFrame,String sTipo,Object oValor,ArrayList<DatoGeneral> arrDatoGeneral) throws Exception {	
		//CONTROL_1
	}
