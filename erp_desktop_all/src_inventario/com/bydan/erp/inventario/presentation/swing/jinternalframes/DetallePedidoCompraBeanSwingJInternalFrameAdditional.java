...
public class DetallePedidoCompraBeanSwingJInternalFrameAdditional extends JInternalFrameBase//DetallePedidoCompraBeanSwingJInternalFrame
{
private static final long serialVersionUID = 1L;
	//CONTROL_INICIO
	DetallePedidoCompraLogic detallepedidocompraLogic;
	DetallePedidoCompraLogicAdditional detallepedidocompraLogicAdditional;
	Mensaje mensaje;
	public static int openFrameCount = 0;
    public static final int xOffset = 10, yOffset = 35;
	
	
	public  DetallePedidoCompraBeanSwingJInternalFrameAdditional(PaginaTipo paginaTipo) throws Exception
	{
		super(paginaTipo);
		try 
		{			
			
			detallepedidocompraLogic=new DetallePedidoCompraLogic();
			detallepedidocompraLogicAdditional=new DetallePedidoCompraLogicAdditional();
	...
	public static void	RecargarFormDetallePedidoCompra(DetallePedidoCompraBeanSwingJInternalFrame detallepedidocompraBeanSwingJInternalFrame,String sTipo,Object oValor,ArrayList<DatoGeneral> arrDatoGeneral) throws Exception {	
		//CONTROL_1
	}
	...
	public static GeneralEntityParameterReturnGeneral procesarEventosVista(ParametroGeneralUsuario parametroGeneralUsuario,Modulo modulo,Opcion opcion,Usuario usuario,JInternalFrameBase jInternalFrameBase,FuncionTipo funcionTipo,ControlTipo controlTipo,EventoTipo eventoTipo,EventoSubTipo eventoSubTipo,String sTipo,Object object,Object objects,GeneralEntityParameterReturnGeneral generalEntityParameterGeneral,GeneralEntityParameterReturnGeneral generalEntityReturnGeneral)throws Exception {
		try {
			...
			DetallePedidoCompraBeanSwingJInternalFrame this_a=(DetallePedidoCompraBeanSwingJInternalFrame)jInternalFrameBase;
			...
			if(funcionTipo.equals(FuncionTipo.AFTER) && controlTipo.equals(ControlTipo.TEXTBOX) && eventoTipo.equals(EventoTipo.CHANGE) && eventoSubTipo.equals(EventoSubTipo.CHANGED)) {
				...
				if(sTipo.equals("cantidad_pedidoDetallePedidoCompra")) {
					...
					if(!this_a.getEsControlTabla()) {
						...
						this_a.setVariablesFormularioToObjetoActualDetallePedidoCompra(this_a.getdetallepedidocompra(),true);
											
						DetalleMovimientoInventarioLogicAdditional.GetCostoTotal(this_a.getdetallepedidocompra());
						
						this_a.setVariablesObjetoActualToFormularioDetallePedidoCompra(this_a.getdetallepedidocompra());
					
					} else {
						
						DetalleMovimientoInventarioLogicAdditional.GetCostoTotal(this_a.getdetallepedidocompraAnterior());
						
						this_a.actualizarVisualTableDatosEventosVistaDetallePedidoCompra();
				...
				if(sTipo.equals("id_productoDetallePedidoCompra")) {
					
					if(!this_a.getEsControlTabla()) {
						
						this_a.setVariablesFormularioToObjetoActualDetallePedidoCompra(this_a.getdetallepedidocompra(),true);
										
						datoGeneral=DetalleMovimientoInventarioLogicAdditional.GetDisponibleYCosto(this_a.getdetallepedidocompra());
						
						Integer disponible=datoGeneral.getiValorInteger();
						Double costo_unitario=datoGeneral.getdValorDouble();
						
						if(disponible>-1) {
							//this_a.getdetallepedidocompra().setdisponible(disponible);														
						}
						
						if(costo_unitario>0) {
							this_a.getdetallepedidocompra().setcosto_unitario(costo_unitario);
						}
						...
						datoGeneral=DetalleMovimientoInventarioLogicAdditional.GetDisponibleYCosto(this_a.getdetallepedidocompraAnterior());
						
						Integer disponible=datoGeneral.getiValorInteger();
						Double costo_unitario=datoGeneral.getdValorDouble();
						
						if(disponible>-1) {
							//this_a.getdetallepedidocompraAnterior().setdisponible(disponible);		
