...
public class DetalleRequisicionBeanSwingJInternalFrameAdditional extends JInternalFrameBase//DetalleRequisicionBeanSwingJInternalFrame
{
private static final long serialVersionUID = 1L;
	//CONTROL_INICIO
	DetalleRequisicionLogic detallerequisicionLogic;
	DetalleRequisicionLogicAdditional detallerequisicionLogicAdditional;
	Mensaje mensaje;
	public static int openFrameCount = 0;
    public static final int xOffset = 10, yOffset = 35;
	
	
	public  DetalleRequisicionBeanSwingJInternalFrameAdditional(PaginaTipo paginaTipo) throws Exception
	{
		super(paginaTipo);
		try 
		{			
			
			detallerequisicionLogic=new DetalleRequisicionLogic();
			detallerequisicionLogicAdditional=new DetalleRequisicionLogicAdditional();
	...
	public static void	RecargarFormDetalleRequisicion(DetalleRequisicionBeanSwingJInternalFrame detallerequisicionBeanSwingJInternalFrame,String sTipo,Object oValor,ArrayList<DatoGeneral> arrDatoGeneral) throws Exception {	
		//CONTROL_1
	}
	...
	public static GeneralEntityParameterReturnGeneral procesarEventosVista(ParametroGeneralUsuario parametroGeneralUsuario,Modulo modulo,Opcion opcion,Usuario usuario,JInternalFrameBase jInternalFrameBase,FuncionTipo funcionTipo,ControlTipo controlTipo,EventoTipo eventoTipo,EventoSubTipo eventoSubTipo,String sTipo,Object object,Object objects,GeneralEntityParameterReturnGeneral generalEntityParameterGeneral,GeneralEntityParameterReturnGeneral generalEntityReturnGeneral)throws Exception {
		try {
			...
			DetalleRequisicionBeanSwingJInternalFrame this_a=(DetalleRequisicionBeanSwingJInternalFrame)jInternalFrameBase;
			...
			if(controlTipo.equals(ControlTipo.WINDOW)) {
				...
				if(funcionTipo.equals(FuncionTipo.LAST) && eventoSubTipo.equals(EventoSubTipo.NEW)) {
					//DetalleRequisicion detalleRequisicion=(DetalleRequisicion)object;
					
					Requisicion requisicion=this_a.getdetallerequisicion().getRequisicion();										
					
					this_a.getdetallerequisicion().setid_bodega(requisicion.getid_bodega_solicita());
					
					this_a.setVariablesObjetoActualToFormularioTodoDetalleRequisicion(this_a.getdetallerequisicion());
				}
				//EventoSubTipo eventoSubTipo
