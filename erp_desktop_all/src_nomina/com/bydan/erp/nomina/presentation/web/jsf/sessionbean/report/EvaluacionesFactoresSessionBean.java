...
public class EvaluacionesFactoresSessionBean  extends EvaluacionesFactoresSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores;
	protected Long lIdEvaluacionesFactoresActualForeignKey;	
	
	protected Long lIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras;
	protected String sUltimaBusquedaEvaluacionesFactores;
	...
	public EvaluacionesFactoresSessionBean () {
		this.inicializarEvaluacionesFactoresSessionBean();
	}
	
	public void inicializarEvaluacionesFactoresSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores=false;
		this.lIdEvaluacionesFactoresActualForeignKey=0L;
		this.lIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras=false;
		this.sUltimaBusquedaEvaluacionesFactores ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores= isPermiteNavegacionHaciaForeignKeyDesdeEvaluacionesFactores;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores(String sNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores = sNombrePaginaNavegacionHaciaForeignKeyDesdeEvaluacionesFactores;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores() {
		return isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores= isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactores;
	}
					
	public Long getlIdEvaluacionesFactoresActualForeignKey() {
		return lIdEvaluacionesFactoresActualForeignKey;
	}

	public void setlIdEvaluacionesFactoresActualForeignKey(
			Long lIdEvaluacionesFactoresActualForeignKey) {
		this.lIdEvaluacionesFactoresActualForeignKey = lIdEvaluacionesFactoresActualForeignKey;
	}
				    
	public Long getlIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras() {
		return lIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras;
	}

	public void setlIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras(
			Long lIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras) {
		this.lIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras = lIdEvaluacionesFactoresActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyEvaluacionesFactoresParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaEvaluacionesFactores() {
		return sUltimaBusquedaEvaluacionesFactores;
	}

	public void setsUltimaBusquedaEvaluacionesFactores(String sUltimaBusquedaEvaluacionesFactores) {
		this.sUltimaBusquedaEvaluacionesFactores = sUltimaBusquedaEvaluacionesFactores;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("EvaluacionesFactores:Valor nulo no permitido en columna id");
					}
				}
