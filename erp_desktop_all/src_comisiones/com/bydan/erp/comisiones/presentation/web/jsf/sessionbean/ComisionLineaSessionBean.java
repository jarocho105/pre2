...
public class ComisionLineaSessionBean  extends ComisionLineaSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeComisionLinea;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionLinea;
	protected Long lIdComisionLineaActualForeignKey;	
	
	protected Long lIdComisionLineaActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras;
	protected String sUltimaBusquedaComisionLinea;
	...
	public ComisionLineaSessionBean () {
		this.inicializarComisionLineaSessionBean();
	}
	
	public void inicializarComisionLineaSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeComisionLinea=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionLinea=false;
		this.lIdComisionLineaActualForeignKey=0L;
		this.lIdComisionLineaActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras=false;
		this.sUltimaBusquedaComisionLinea ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeComisionLinea() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeComisionLinea;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeComisionLinea(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeComisionLinea) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeComisionLinea= isPermiteNavegacionHaciaForeignKeyDesdeComisionLinea;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea(String sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea = sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionLinea;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyComisionLinea() {
		return isBusquedaDesdeForeignKeySesionForeignKeyComisionLinea;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyComisionLinea(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionLinea) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionLinea= isBusquedaDesdeForeignKeySesionForeignKeyComisionLinea;
	}
					
	public Long getlIdComisionLineaActualForeignKey() {
		return lIdComisionLineaActualForeignKey;
	}

	public void setlIdComisionLineaActualForeignKey(
			Long lIdComisionLineaActualForeignKey) {
		this.lIdComisionLineaActualForeignKey = lIdComisionLineaActualForeignKey;
	}
				    
	public Long getlIdComisionLineaActualForeignKeyParaPosibleAtras() {
		return lIdComisionLineaActualForeignKeyParaPosibleAtras;
	}

	public void setlIdComisionLineaActualForeignKeyParaPosibleAtras(
			Long lIdComisionLineaActualForeignKeyParaPosibleAtras) {
		this.lIdComisionLineaActualForeignKeyParaPosibleAtras = lIdComisionLineaActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyComisionLineaParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaComisionLinea() {
		return sUltimaBusquedaComisionLinea;
	}

	public void setsUltimaBusquedaComisionLinea(String sUltimaBusquedaComisionLinea) {
		this.sUltimaBusquedaComisionLinea = sUltimaBusquedaComisionLinea;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionLinea:Valor nulo no permitido en columna id");
					}
				}
