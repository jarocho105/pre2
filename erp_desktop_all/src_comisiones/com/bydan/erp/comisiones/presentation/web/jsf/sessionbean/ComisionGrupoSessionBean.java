...
public class ComisionGrupoSessionBean  extends ComisionGrupoSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo;
	protected Long lIdComisionGrupoActualForeignKey;	
	
	protected Long lIdComisionGrupoActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras;
	protected String sUltimaBusquedaComisionGrupo;
	...
	public ComisionGrupoSessionBean () {
		this.inicializarComisionGrupoSessionBean();
	}
	
	public void inicializarComisionGrupoSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo=false;
		this.lIdComisionGrupoActualForeignKey=0L;
		this.lIdComisionGrupoActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras=false;
		this.sUltimaBusquedaComisionGrupo ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo= isPermiteNavegacionHaciaForeignKeyDesdeComisionGrupo;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo(String sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo = sNombrePaginaNavegacionHaciaForeignKeyDesdeComisionGrupo;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo() {
		return isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo= isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupo;
	}
					
	public Long getlIdComisionGrupoActualForeignKey() {
		return lIdComisionGrupoActualForeignKey;
	}

	public void setlIdComisionGrupoActualForeignKey(
			Long lIdComisionGrupoActualForeignKey) {
		this.lIdComisionGrupoActualForeignKey = lIdComisionGrupoActualForeignKey;
	}
				    
	public Long getlIdComisionGrupoActualForeignKeyParaPosibleAtras() {
		return lIdComisionGrupoActualForeignKeyParaPosibleAtras;
	}

	public void setlIdComisionGrupoActualForeignKeyParaPosibleAtras(
			Long lIdComisionGrupoActualForeignKeyParaPosibleAtras) {
		this.lIdComisionGrupoActualForeignKeyParaPosibleAtras = lIdComisionGrupoActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyComisionGrupoParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaComisionGrupo() {
		return sUltimaBusquedaComisionGrupo;
	}

	public void setsUltimaBusquedaComisionGrupo(String sUltimaBusquedaComisionGrupo) {
		this.sUltimaBusquedaComisionGrupo = sUltimaBusquedaComisionGrupo;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna id");
					}
				}
