...
public class TimeRenderer extends DefaultTableCellRenderer implements TableCellRenderer{	
	...
	public TimeRenderer(Boolean conEnabled) {
		this.renderer = new JLabel();
		this.iTotalRow=0;
	...
	public TimeRenderer(Border borderResaltar,Boolean conEnabled) {
	...
	public TimeRenderer(Border borderResaltar,Boolean conEnabled,Integer iTotalRow) {
		this.borderResaltar=borderResaltar;
		this.renderer = new JLabel();
	...
	public TimeRenderer(Border borderResaltar) {
		this(borderResaltar,true);
	}
	
	public TimeRenderer(Border borderResaltar,Boolean conEnabled,JInternalFrameBase jInternalFrameBase,Boolean conHotKeys,String sNombreHotKeyAbstractAction,String sTipoBusqueda) {
	...
	public TimeRenderer(Border borderResaltar,Boolean conEnabled,Integer iTotalRow,JInternalFrameBase jInternalFrameBase,Boolean conHotKeys,String sNombreHotKeyAbstractAction,String sTipoBusqueda) {
		//super(new JTextField());
		this.borderResaltar=borderResaltar;
		this.conEnabled=conEnabled;
		this.iTotalRow=iTotalRow;
