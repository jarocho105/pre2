...
public class DateRenderer extends DefaultTableCellRenderer implements TableCellRenderer{	
	...
	public DateRenderer(Boolean conEnabled) {
		this.renderer = new JLabel();
		this.iTotalRow=0;
	...
	public DateRenderer(Border borderResaltar,Boolean conEnabled) {
	...
	public DateRenderer(Border borderResaltar,Boolean conEnabled,Integer iTotalRow) {
		this.borderResaltar=borderResaltar;
		this.renderer = new JLabel();
	...
	public DateRenderer(Border borderResaltar,Boolean conEnabled,Integer iTotalRow,JInternalFrameBase jInternalFrameBase,Boolean conHotKeys,String sNombreHotKeyAbstractAction,String sTipoBusqueda) {
		this.borderResaltar=borderResaltar;
		this.renderer = new JLabel();
		this.iTotalRow=iTotalRow;
		this.conEnabled=conEnabled;
	...
	public DateRenderer(Border borderResaltar,Boolean conEnabled,JInternalFrameBase jInternalFrameBase,Boolean conHotKeys,String sNombreHotKeyAbstractAction,String sTipoBusqueda) {
		this.borderResaltar=borderResaltar;
		this.renderer = new JLabel();
		this.iTotalRow=0;
		this.conEnabled=conEnabled;
	...
	public DateRenderer(Border borderResaltar) {
