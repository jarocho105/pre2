...
public abstract class JPanelLazyMe extends JPanel
{
    /**
	 * 
	 */
     ...
     * Make a LazyPanel.
     */
    protected JPanelLazyMe ()
    {
        setConstructorFinished(true);
    }
...
example
	...
	public boolean isConstructorFinished() {
		return isConstructorFinished;
	}

	public void setConstructorFinished(boolean isConstructorFinished) {
		this.isConstructorFinished = isConstructorFinished;
	}
}