...
public class SplashScreenJInternalFrame extends JInternalFrame implements Runnable {
  /**
	 * 
	 */
    ...
    public SplashScreenJInternalFrame splashScreenJInternalFrame=null;
    
    public SplashScreenJInternalFrame(SplashScreenJInternalFrame splashScreenJInternalFrame,int theValueProgress,String theMessage) {
		this.theValueProgress=theValueProgress;
		this.theMessage=theMessage;
		this.splashScreenJInternalFrame=splashScreenJInternalFrame;
	}
    
	public SplashScreenJInternalFrame() {	  
		this(true,true, SplashScreenJInternalFrame.NUMERO_EJECUSION);
	}
	
	public SplashScreenJInternalFrame(Boolean isIndeterminate,Boolean esMostrarGif) {	  
		this(isIndeterminate,esMostrarGif, SplashScreenJInternalFrame.NUMERO_EJECUSION);
	}
	
  public SplashScreenJInternalFrame(Boolean isIndeterminate,Boolean esMostrarGif,Integer iNumeroEjecusionDemora) {	
	...
	if(!this.esMostrarGif) {
		this.iWidthFinal=SplashScreenJInternalFrame.WIDTH;
		this.iHeightFinal=SplashScreenJInternalFrame.HEIGHT;
	} else {
		this.iWidthFinal=SplashScreenJInternalFrame.WIDTH_GIF;
		this.iHeightFinal=SplashScreenJInternalFrame.HEIGHT_GIF;
  ...
  public void initializeJProgressBar(Boolean isIndeterminate){
		this.jProgressBar = new JProgressBar(0, SplashScreenJInternalFrame.MAX);
  ...
  public void setValueProgress(int valueProgress) {
	if(!this.esMostrarGif) {
	    ...
	    */
	    ...
	    SwingUtilities.invokeLater(new SplashScreenJInternalFrame(this,valueProgress,""));
	}
  }
  ...
  public void setProgress(String message, int valueProgress) {
	if(!this.esMostrarGif) {
	    ...
	    */
	    ...
	    SwingUtilities.invokeLater(new SplashScreenJInternalFrame(this,valueProgress,message));
	}
  }
  ...
  public void run() {
	  try {
		  ...
		  splashScreenJInternalFrame.jProgressBar.setValue(theValueProgress);
		  splashScreenJInternalFrame.setMessage(theMessage);
