...
public class TreeAuxYahooExtTemp {
	...
	private ArrayList<TreeAuxYahooExtTemp> auxTreesYahoo= new ArrayList<TreeAuxYahooExtTemp>();
	...
	public ArrayList<TreeAuxYahooExtTemp> getAuxTreesYahoo() {
		return auxTreesYahoo;
	}
	
	public void setAuxTreesYahoo(ArrayList<TreeAuxYahooExtTemp> auxTreesYahoo) {
	...
	public static void setEndKey(String endKey) {
		TreeAuxYahooExtTemp.endKey = endKey;
	}
	...
	public static void setStartKey(String startKey) {
		TreeAuxYahooExtTemp.startKey = startKey;
	}
