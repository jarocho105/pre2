...
public class DetalleMoviClienProveSessionBean  extends DetalleMoviClienProveSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve;
	protected Long lIdDetalleMoviClienProveActualForeignKey;	
	
	protected Long lIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras;
	protected String sUltimaBusquedaDetalleMoviClienProve;
	...
	public DetalleMoviClienProveSessionBean () {
		this.inicializarDetalleMoviClienProveSessionBean();
	}
	
	public void inicializarDetalleMoviClienProveSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve=false;
		this.lIdDetalleMoviClienProveActualForeignKey=0L;
		this.lIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras=false;
		this.sUltimaBusquedaDetalleMoviClienProve ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve= isPermiteNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve(String sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve = sNombrePaginaNavegacionHaciaForeignKeyDesdeDetalleMoviClienProve;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve= isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProve;
	}
					
	public Long getlIdDetalleMoviClienProveActualForeignKey() {
		return lIdDetalleMoviClienProveActualForeignKey;
	}

	public void setlIdDetalleMoviClienProveActualForeignKey(
			Long lIdDetalleMoviClienProveActualForeignKey) {
		this.lIdDetalleMoviClienProveActualForeignKey = lIdDetalleMoviClienProveActualForeignKey;
	}
				    
	public Long getlIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras() {
		return lIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras;
	}

	public void setlIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras(
			Long lIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras) {
		this.lIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras = lIdDetalleMoviClienProveActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyDetalleMoviClienProveParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaDetalleMoviClienProve() {
		return sUltimaBusquedaDetalleMoviClienProve;
	}

	public void setsUltimaBusquedaDetalleMoviClienProve(String sUltimaBusquedaDetalleMoviClienProve) {
		this.sUltimaBusquedaDetalleMoviClienProve = sUltimaBusquedaDetalleMoviClienProve;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id");
					}
				}
