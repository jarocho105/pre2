...
public class PedidoProduSessionBean  extends PedidoProduSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdePedidoProdu;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu;
	protected Long lIdPedidoProduActualForeignKey;	
	
	protected Long lIdPedidoProduActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras;
	protected String sUltimaBusquedaPedidoProdu;
	...
	public PedidoProduSessionBean () {
		this.inicializarPedidoProduSessionBean();
	}
	
	public void inicializarPedidoProduSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdePedidoProdu=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu=false;
		this.lIdPedidoProduActualForeignKey=0L;
		this.lIdPedidoProduActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras=false;
		this.sUltimaBusquedaPedidoProdu ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdePedidoProdu() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdePedidoProdu;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdePedidoProdu(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdePedidoProdu) {
		this.isPermiteNavegacionHaciaForeignKeyDesdePedidoProdu= isPermiteNavegacionHaciaForeignKeyDesdePedidoProdu;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu(String sNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu = sNombrePaginaNavegacionHaciaForeignKeyDesdePedidoProdu;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu() {
		return isBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu= isBusquedaDesdeForeignKeySesionForeignKeyPedidoProdu;
	}
					
	public Long getlIdPedidoProduActualForeignKey() {
		return lIdPedidoProduActualForeignKey;
	}

	public void setlIdPedidoProduActualForeignKey(
			Long lIdPedidoProduActualForeignKey) {
		this.lIdPedidoProduActualForeignKey = lIdPedidoProduActualForeignKey;
	}
				    
	public Long getlIdPedidoProduActualForeignKeyParaPosibleAtras() {
		return lIdPedidoProduActualForeignKeyParaPosibleAtras;
	}

	public void setlIdPedidoProduActualForeignKeyParaPosibleAtras(
			Long lIdPedidoProduActualForeignKeyParaPosibleAtras) {
		this.lIdPedidoProduActualForeignKeyParaPosibleAtras = lIdPedidoProduActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyPedidoProduParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaPedidoProdu() {
		return sUltimaBusquedaPedidoProdu;
	}

	public void setsUltimaBusquedaPedidoProdu(String sUltimaBusquedaPedidoProdu) {
		this.sUltimaBusquedaPedidoProdu = sUltimaBusquedaPedidoProdu;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id");
					}
				}
