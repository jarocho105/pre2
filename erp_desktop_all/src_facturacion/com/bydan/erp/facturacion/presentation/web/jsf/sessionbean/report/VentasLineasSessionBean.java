...
public class VentasLineasSessionBean  extends VentasLineasSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeVentasLineas;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyVentasLineas;
	protected Long lIdVentasLineasActualForeignKey;	
	
	protected Long lIdVentasLineasActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras;
	protected String sUltimaBusquedaVentasLineas;
	...
	public VentasLineasSessionBean () {
		this.inicializarVentasLineasSessionBean();
	}
	
	public void inicializarVentasLineasSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeVentasLineas=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyVentasLineas=false;
		this.lIdVentasLineasActualForeignKey=0L;
		this.lIdVentasLineasActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras=false;
		this.sUltimaBusquedaVentasLineas ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeVentasLineas() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeVentasLineas;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeVentasLineas(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeVentasLineas) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeVentasLineas= isPermiteNavegacionHaciaForeignKeyDesdeVentasLineas;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas(String sNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas = sNombrePaginaNavegacionHaciaForeignKeyDesdeVentasLineas;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyVentasLineas() {
		return isBusquedaDesdeForeignKeySesionForeignKeyVentasLineas;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyVentasLineas(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyVentasLineas) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyVentasLineas= isBusquedaDesdeForeignKeySesionForeignKeyVentasLineas;
	}
					
	public Long getlIdVentasLineasActualForeignKey() {
		return lIdVentasLineasActualForeignKey;
	}

	public void setlIdVentasLineasActualForeignKey(
			Long lIdVentasLineasActualForeignKey) {
		this.lIdVentasLineasActualForeignKey = lIdVentasLineasActualForeignKey;
	}
				    
	public Long getlIdVentasLineasActualForeignKeyParaPosibleAtras() {
		return lIdVentasLineasActualForeignKeyParaPosibleAtras;
	}

	public void setlIdVentasLineasActualForeignKeyParaPosibleAtras(
			Long lIdVentasLineasActualForeignKeyParaPosibleAtras) {
		this.lIdVentasLineasActualForeignKeyParaPosibleAtras = lIdVentasLineasActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyVentasLineasParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaVentasLineas() {
		return sUltimaBusquedaVentasLineas;
	}

	public void setsUltimaBusquedaVentasLineas(String sUltimaBusquedaVentasLineas) {
		this.sUltimaBusquedaVentasLineas = sUltimaBusquedaVentasLineas;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("VentasLineas:Valor nulo no permitido en columna id");
					}
				}
