...
public class NotaCreditoSessionBean  extends NotaCreditoSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeNotaCredito;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyNotaCredito;
	protected Long lIdNotaCreditoActualForeignKey;	
	
	protected Long lIdNotaCreditoActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras;
	protected String sUltimaBusquedaNotaCredito;
	...
	Boolean isBusquedaDesdeForeignKeySesionEstadoNotaCredito;
	Long lidEstadoNotaCreditoActual;
	...
	public NotaCreditoSessionBean () {
		this.inicializarNotaCreditoSessionBean();
	}
	
	public void inicializarNotaCreditoSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeNotaCredito=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyNotaCredito=false;
		this.lIdNotaCreditoActualForeignKey=0L;
		this.lIdNotaCreditoActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras=false;
		this.sUltimaBusquedaNotaCredito ="";
		...
		isBusquedaDesdeForeignKeySesionEstadoNotaCredito=false;
		lidEstadoNotaCreditoActual=0L;
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeNotaCredito() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeNotaCredito;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeNotaCredito(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeNotaCredito) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeNotaCredito= isPermiteNavegacionHaciaForeignKeyDesdeNotaCredito;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito(String sNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito = sNombrePaginaNavegacionHaciaForeignKeyDesdeNotaCredito;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyNotaCredito() {
		return isBusquedaDesdeForeignKeySesionForeignKeyNotaCredito;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyNotaCredito(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyNotaCredito) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyNotaCredito= isBusquedaDesdeForeignKeySesionForeignKeyNotaCredito;
	}
					
	public Long getlIdNotaCreditoActualForeignKey() {
		return lIdNotaCreditoActualForeignKey;
	}

	public void setlIdNotaCreditoActualForeignKey(
			Long lIdNotaCreditoActualForeignKey) {
		this.lIdNotaCreditoActualForeignKey = lIdNotaCreditoActualForeignKey;
	}
				    
	public Long getlIdNotaCreditoActualForeignKeyParaPosibleAtras() {
		return lIdNotaCreditoActualForeignKeyParaPosibleAtras;
	}

	public void setlIdNotaCreditoActualForeignKeyParaPosibleAtras(
			Long lIdNotaCreditoActualForeignKeyParaPosibleAtras) {
		this.lIdNotaCreditoActualForeignKeyParaPosibleAtras = lIdNotaCreditoActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyNotaCreditoParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaNotaCredito() {
		return sUltimaBusquedaNotaCredito;
	}

	public void setsUltimaBusquedaNotaCredito(String sUltimaBusquedaNotaCredito) {
		this.sUltimaBusquedaNotaCredito = sUltimaBusquedaNotaCredito;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeForeignKeySesionEstadoNotaCredito() {
		return isBusquedaDesdeForeignKeySesionEstadoNotaCredito;
	}

	public void setisBusquedaDesdeForeignKeySesionEstadoNotaCredito(
		Boolean isBusquedaDesdeForeignKeySesionEstadoNotaCredito) {
		this.isBusquedaDesdeForeignKeySesionEstadoNotaCredito = isBusquedaDesdeForeignKeySesionEstadoNotaCredito;
	}

	public Long getlidEstadoNotaCreditoActual() {
		return lidEstadoNotaCreditoActual;
	}

	public void setlidEstadoNotaCreditoActual(Long lidEstadoNotaCreditoActual) {
		this.lidEstadoNotaCreditoActual = lidEstadoNotaCreditoActual;
	}
