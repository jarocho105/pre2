...
public class ProcesoRecibosSessionBean  extends ProcesoRecibosSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos;
	protected Long lIdProcesoRecibosActualForeignKey;	
	
	protected Long lIdProcesoRecibosActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras;
	protected String sUltimaBusquedaProcesoRecibos;
	...
	public ProcesoRecibosSessionBean () {
		this.inicializarProcesoRecibosSessionBean();
	}
	
	public void inicializarProcesoRecibosSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos=false;
		this.lIdProcesoRecibosActualForeignKey=0L;
		this.lIdProcesoRecibosActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras=false;
		this.sUltimaBusquedaProcesoRecibos ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos= isPermiteNavegacionHaciaForeignKeyDesdeProcesoRecibos;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos(String sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos = sNombrePaginaNavegacionHaciaForeignKeyDesdeProcesoRecibos;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos= isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibos;
	}
					
	public Long getlIdProcesoRecibosActualForeignKey() {
		return lIdProcesoRecibosActualForeignKey;
	}

	public void setlIdProcesoRecibosActualForeignKey(
			Long lIdProcesoRecibosActualForeignKey) {
		this.lIdProcesoRecibosActualForeignKey = lIdProcesoRecibosActualForeignKey;
	}
				    
	public Long getlIdProcesoRecibosActualForeignKeyParaPosibleAtras() {
		return lIdProcesoRecibosActualForeignKeyParaPosibleAtras;
	}

	public void setlIdProcesoRecibosActualForeignKeyParaPosibleAtras(
			Long lIdProcesoRecibosActualForeignKeyParaPosibleAtras) {
		this.lIdProcesoRecibosActualForeignKeyParaPosibleAtras = lIdProcesoRecibosActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyProcesoRecibosParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaProcesoRecibos() {
		return sUltimaBusquedaProcesoRecibos;
	}

	public void setsUltimaBusquedaProcesoRecibos(String sUltimaBusquedaProcesoRecibos) {
		this.sUltimaBusquedaProcesoRecibos = sUltimaBusquedaProcesoRecibos;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoRecibos:Valor nulo no permitido en columna id");
					}
				}
