...
public class DetaFormaPagoSessionBean  extends DetaFormaPagoSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago;
	protected Long lIdDetaFormaPagoActualForeignKey;	
	
	protected Long lIdDetaFormaPagoActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras;
	protected String sUltimaBusquedaDetaFormaPago;
	...
	Boolean isBusquedaDesdeForeignKeySesionTipoDetaFormaPago;
	Long lidTipoDetaFormaPagoActual;
	Boolean isBusquedaDesdeForeignKeySesionDetaFormaPagoFactu;
	Long lidDetaFormaPagoFactuActual;
	...
	public DetaFormaPagoSessionBean () {
		this.inicializarDetaFormaPagoSessionBean();
	}
	
	public void inicializarDetaFormaPagoSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago=false;
		this.lIdDetaFormaPagoActualForeignKey=0L;
		this.lIdDetaFormaPagoActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras=false;
		this.sUltimaBusquedaDetaFormaPago ="";
		...
		isBusquedaDesdeForeignKeySesionTipoDetaFormaPago=false;
		lidTipoDetaFormaPagoActual=0L;
		isBusquedaDesdeForeignKeySesionDetaFormaPagoFactu=false;
		lidDetaFormaPagoFactuActual=0L;
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago= isPermiteNavegacionHaciaForeignKeyDesdeDetaFormaPago;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago(String sNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago = sNombrePaginaNavegacionHaciaForeignKeyDesdeDetaFormaPago;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago= isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPago;
	}
					
	public Long getlIdDetaFormaPagoActualForeignKey() {
		return lIdDetaFormaPagoActualForeignKey;
	}

	public void setlIdDetaFormaPagoActualForeignKey(
			Long lIdDetaFormaPagoActualForeignKey) {
		this.lIdDetaFormaPagoActualForeignKey = lIdDetaFormaPagoActualForeignKey;
	}
				    
	public Long getlIdDetaFormaPagoActualForeignKeyParaPosibleAtras() {
		return lIdDetaFormaPagoActualForeignKeyParaPosibleAtras;
	}

	public void setlIdDetaFormaPagoActualForeignKeyParaPosibleAtras(
			Long lIdDetaFormaPagoActualForeignKeyParaPosibleAtras) {
		this.lIdDetaFormaPagoActualForeignKeyParaPosibleAtras = lIdDetaFormaPagoActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyDetaFormaPagoParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaDetaFormaPago() {
		return sUltimaBusquedaDetaFormaPago;
	}

	public void setsUltimaBusquedaDetaFormaPago(String sUltimaBusquedaDetaFormaPago) {
		this.sUltimaBusquedaDetaFormaPago = sUltimaBusquedaDetaFormaPago;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetaFormaPago:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeForeignKeySesionTipoDetaFormaPago() {
		return isBusquedaDesdeForeignKeySesionTipoDetaFormaPago;
	}

	public void setisBusquedaDesdeForeignKeySesionTipoDetaFormaPago(
		Boolean isBusquedaDesdeForeignKeySesionTipoDetaFormaPago) {
		this.isBusquedaDesdeForeignKeySesionTipoDetaFormaPago = isBusquedaDesdeForeignKeySesionTipoDetaFormaPago;
	}

	public Long getlidTipoDetaFormaPagoActual() {
		return lidTipoDetaFormaPagoActual;
	}

	public void setlidTipoDetaFormaPagoActual(Long lidTipoDetaFormaPagoActual) {
		this.lidTipoDetaFormaPagoActual = lidTipoDetaFormaPagoActual;
	}
	public Boolean getisBusquedaDesdeForeignKeySesionDetaFormaPagoFactu() {
		return isBusquedaDesdeForeignKeySesionDetaFormaPagoFactu;
	}

	public void setisBusquedaDesdeForeignKeySesionDetaFormaPagoFactu(
		Boolean isBusquedaDesdeForeignKeySesionDetaFormaPagoFactu) {
		this.isBusquedaDesdeForeignKeySesionDetaFormaPagoFactu = isBusquedaDesdeForeignKeySesionDetaFormaPagoFactu;
	}

	public Long getlidDetaFormaPagoFactuActual() {
		return lidDetaFormaPagoFactuActual;
	}

	public void setlidDetaFormaPagoFactuActual(Long lidDetaFormaPagoFactuActual) {
		this.lidDetaFormaPagoFactuActual = lidDetaFormaPagoFactuActual;
	}
