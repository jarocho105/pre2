...
public class ComprobantesAnuladosJInternalFrame extends ComprobantesAnuladosBeanSwingJInternalFrameAdditional {	
	...
	public JPanel jPanelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados;
	public JLabel jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados;
	@SuppressWarnings("rawtypes")
	public JComboBox jComboBoxid_moduloBusquedaComprobantesAnuladosComprobantesAnulados;
	public JButton jButtonid_moduloBusquedaComprobantesAnuladosComprobantesAnulados= new JButtonMe();
	public JButton jButtonid_moduloBusquedaComprobantesAnuladosComprobantesAnuladosUpdate= new JButtonMe();
	public JButton jButtonid_moduloBusquedaComprobantesAnuladosComprobantesAnuladosBusqueda= new JButtonMe();
	...
	public JPanel jPanelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados;
	public JLabel jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados;
	//public JFormattedTextField jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados;

	public JDateChooser jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados;
	public JButton jButtonfecha_desdeBusquedaComprobantesAnuladosComprobantesAnuladosBusqueda= new JButtonMe();

	
	public JPanel jPanelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados;
	public JLabel jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados;
	//public JFormattedTextField jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados;

	public JDateChooser jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados;
	public JButton jButtonfecha_hastaBusquedaComprobantesAnuladosComprobantesAnuladosBusqueda= new JButtonMe();
	...
	*/
	...
	public void inicializarElementosBusquedasComprobantesAnulados() {
		...
		this.jPanelBusquedaComprobantesAnuladosComprobantesAnulados.setToolTipText("Buscar Por Ejercicio Por Modulo Por Tipo Movimiento Base Por Fecha Desde Por Fecha Hasta ");
		...
		this.jButtonBusquedaComprobantesAnuladosComprobantesAnulados.setToolTipText("Buscar Por Ejercicio Por Modulo Por Tipo Movimiento Base Por Fecha Desde Por Fecha Hasta ");
		FuncionesSwing.addImagenButtonGeneral(this.jButtonBusquedaComprobantesAnuladosComprobantesAnulados,"buscar_button","Buscar Por Ejercicio Por Modulo Por Tipo Movimiento Base Por Fecha Desde Por Fecha Hasta ");
		...
		jLabelid_ejercicioBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelid_ejercicioBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelid_ejercicioBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		...
		jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados = new JLabelMe();
		jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setText("Modulo :");
		jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setToolTipText("Modulo");
		jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));

		FuncionesSwing.setBoldLabel(jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados,STIPO_TAMANIO_GENERAL,false,true,this);

		jComboBoxid_moduloBusquedaComprobantesAnuladosComprobantesAnulados= new JComboBoxMe();
		jComboBoxid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL,0),Constantes.ISWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL,0)));
		jComboBoxid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL,0),Constantes.ISWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL,0)));
		jComboBoxid_moduloBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL,0),Constantes.ISWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL,0)));

		FuncionesSwing.setBoldComboBox(jComboBoxid_moduloBusquedaComprobantesAnuladosComprobantesAnulados,STIPO_TAMANIO_GENERAL,false,true,this);



	
		jLabelid_tipo_movimientoBusquedaComprobantesAnuladosComprobantesAnulados = new JLabelMe();
		jLabelid_tipo_movimientoBusquedaComprobantesAnuladosComprobantesAnulados.setText("Tipo Movimiento Base :");
		jLabelid_tipo_movimientoBusquedaComprobantesAnuladosComprobantesAnulados.setToolTipText("Tipo Movimiento Base");
		jLabelid_tipo_movimientoBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL2*2));
		jLabelid_tipo_movimientoBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL2*2));
		jLabelid_tipo_movimientoBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL2*2));
		...
		jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados = new JLabelMe();
		jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setText("Fecha Desde :");
		jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setToolTipText("Fecha Desde");
		jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));

		FuncionesSwing.setBoldLabel(jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados,STIPO_TAMANIO_GENERAL,false,true,this);

		jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados= new JDateChooser();
		jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_FECHA,0),Constantes.ISWING_ALTO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL_FECHA,0)));
		jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_FECHA,0),Constantes.ISWING_ALTO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL_FECHA,0)));
		jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_FECHA,0),Constantes.ISWING_ALTO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL_FECHA,0)));

		FuncionesSwing.setBoldDate(jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados,STIPO_TAMANIO_GENERAL,false,true,this);
		jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setDate(new Date());
		jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setDateFormatString("yyyy-MM-dd");;
		//jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados.setText(Funciones.getStringMySqlCurrentDate());



	
		jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados = new JLabelMe();
		jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setText("Fecha Hasta :");
		jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setToolTipText("Fecha Hasta");
		jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));
		jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_LABEL,-4),Constantes2.ISWING_ALTO_CONTROL_LABEL));

		FuncionesSwing.setBoldLabel(jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados,STIPO_TAMANIO_GENERAL,false,true,this);

		jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados= new JDateChooser();
		jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setMinimumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_FECHA,0),Constantes.ISWING_ALTO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL_FECHA,0)));
		jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setMaximumSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_FECHA,0),Constantes.ISWING_ALTO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL_FECHA,0)));
		jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setPreferredSize(new Dimension(Constantes.ISWING_ANCHO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ANCHO_CONTROL_FECHA,0),Constantes.ISWING_ALTO_CONTROL_FECHA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_CONTROL_FECHA,0)));

		FuncionesSwing.setBoldDate(jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados,STIPO_TAMANIO_GENERAL,false,true,this);
		jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setDate(new Date());
		jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setDateFormatString("yyyy-MM-dd");;
		//jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados.setText(Funciones.getStringMySqlCurrentDate());
		...
		this.jTabbedPaneBusquedasComprobantesAnulados.setMinimumSize(new Dimension(this.getWidth(),Constantes.ISWING_ALTO_TABPANE_BUSQUEDA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_TABPANE_BUSQUEDA,100)));
		this.jTabbedPaneBusquedasComprobantesAnulados.setMaximumSize(new Dimension(this.getWidth(),Constantes.ISWING_ALTO_TABPANE_BUSQUEDA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_TABPANE_BUSQUEDA,100)));
		this.jTabbedPaneBusquedasComprobantesAnulados.setPreferredSize(new Dimension(this.getWidth(),Constantes.ISWING_ALTO_TABPANE_BUSQUEDA + FuncionesSwing.getValorProporcion(Constantes.ISWING_ALTO_TABPANE_BUSQUEDA,100)));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		*/
		...
		gridBagConstraintsComprobantesAnulados.gridx = 0;
		jPanelBusquedaComprobantesAnuladosComprobantesAnulados.add(jLabelid_moduloBusquedaComprobantesAnuladosComprobantesAnulados, gridBagConstraintsComprobantesAnulados);
		...
		gridBagConstraintsComprobantesAnulados.gridy = 1;
		gridBagConstraintsComprobantesAnulados.gridx = 1;
		jPanelBusquedaComprobantesAnuladosComprobantesAnulados.add(jComboBoxid_moduloBusquedaComprobantesAnuladosComprobantesAnulados, gridBagConstraintsComprobantesAnulados);
		...
		gridBagConstraintsComprobantesAnulados.gridx = 0;
		jPanelBusquedaComprobantesAnuladosComprobantesAnulados.add(jLabelfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados, gridBagConstraintsComprobantesAnulados);
		...
		gridBagConstraintsComprobantesAnulados.gridy = 3;
		gridBagConstraintsComprobantesAnulados.gridx = 1;
		jPanelBusquedaComprobantesAnuladosComprobantesAnulados.add(jDateChooserfecha_desdeBusquedaComprobantesAnuladosComprobantesAnulados, gridBagConstraintsComprobantesAnulados);
		...
		gridBagConstraintsComprobantesAnulados.gridx = 0;
		jPanelBusquedaComprobantesAnuladosComprobantesAnulados.add(jLabelfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados, gridBagConstraintsComprobantesAnulados);
		...
		gridBagConstraintsComprobantesAnulados.gridy = 4;
		gridBagConstraintsComprobantesAnulados.gridx = 1;
		jPanelBusquedaComprobantesAnuladosComprobantesAnulados.add(jDateChooserfecha_hastaBusquedaComprobantesAnuladosComprobantesAnulados, gridBagConstraintsComprobantesAnulados);
		...
		jTabbedPaneBusquedasComprobantesAnulados.addTab("1.-Por Ejercicio Por Modulo Por Tipo Movimiento Base Por Fecha Desde Por Fecha Hasta ", jPanelBusquedaComprobantesAnuladosComprobantesAnulados);
