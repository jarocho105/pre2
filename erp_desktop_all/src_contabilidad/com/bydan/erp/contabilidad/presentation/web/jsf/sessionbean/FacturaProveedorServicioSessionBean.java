...
public class FacturaProveedorServicioSessionBean  extends FacturaProveedorServicioSessionBeanAdditional {
	private static final long serialVersionUID = 1L;
	
	protected Boolean isPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio;
	protected Boolean isPermiteRecargarInformacion;
	protected String sNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio;
	protected Long lIdFacturaProveedorServicioActualForeignKey;	
	
	protected Long lIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras;
	protected Boolean isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras;
	protected String sUltimaBusquedaFacturaProveedorServicio;
	...
	public FacturaProveedorServicioSessionBean () {
		this.inicializarFacturaProveedorServicioSessionBean();
	}
	
	public void inicializarFacturaProveedorServicioSessionBean () {	
		this.isPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio=false;
		
		this.isPermiteRecargarInformacion=false;
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio="";
		this.isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio=false;
		this.lIdFacturaProveedorServicioActualForeignKey=0L;
		this.lIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras=0L;
		this.isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras=false;
		this.sUltimaBusquedaFacturaProveedorServicio ="";
	...
	public Boolean getisPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio() {
		return this.isPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio;
	}

	public void setisPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio(
			Boolean isPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio) {
		this.isPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio= isPermiteNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio;
	}
	...
	public String getsNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio() {
		return this.sNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio;
	}

	public void setsNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio(String sNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio) {
		this.sNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio = sNombrePaginaNavegacionHaciaForeignKeyDesdeFacturaProveedorServicio;
	}
	
	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio() {
		return isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio= isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicio;
	}
					
	public Long getlIdFacturaProveedorServicioActualForeignKey() {
		return lIdFacturaProveedorServicioActualForeignKey;
	}

	public void setlIdFacturaProveedorServicioActualForeignKey(
			Long lIdFacturaProveedorServicioActualForeignKey) {
		this.lIdFacturaProveedorServicioActualForeignKey = lIdFacturaProveedorServicioActualForeignKey;
	}
				    
	public Long getlIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras() {
		return lIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras;
	}

	public void setlIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras(
			Long lIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras) {
		this.lIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras = lIdFacturaProveedorServicioActualForeignKeyParaPosibleAtras;
	}

	public Boolean getisBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras() {
		return isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras;
	}

	public void setisBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras(
			Boolean isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras) {
		this.isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras = isBusquedaDesdeForeignKeySesionForeignKeyFacturaProveedorServicioParaPosibleAtras;
	}
	
	public String getsUltimaBusquedaFacturaProveedorServicio() {
		return sUltimaBusquedaFacturaProveedorServicio;
	}

	public void setsUltimaBusquedaFacturaProveedorServicio(String sUltimaBusquedaFacturaProveedorServicio) {
		this.sUltimaBusquedaFacturaProveedorServicio = sUltimaBusquedaFacturaProveedorServicio;
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaProveedorServicio:Valor nulo no permitido en columna id");
					}
				}
